...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name){
        ...
        //question number
        qn = new JLabel();
        qn.setBounds(30,345,50,70);
        qn.setFont(new Font("Taboma",Font.PLAIN,24));
        add(qn);
        //question
        question = new JLabel();
        question.setBounds(85,345,900,70);
        ...
        opt1.setBounds(110,410,400,30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt1);
        
        opt2 = new JRadioButton();
        opt2.setBounds(110,445,400,30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt2);
        
        opt3 = new JRadioButton();
        opt3.setBounds(110,480,400,30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt3);
        
        opt4 = new JRadioButton();
        opt4.setBounds(110,515,400,30);
        ...
        submit.setBounds(950,535,200,50);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == next){
            ...
            for(int i=0;i<userAnswers.length;i++){
                ...
                setVisible(false);
                //call score function next frame results
